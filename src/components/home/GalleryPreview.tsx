...
export const GalleryPreview = () => {
  ...
  return <>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-10">
            ...
            duration: 0.4
                ...
                <Card className="overflow-hidden h-full group cursor-pointer" onClick={() => openLightbox(index)}>
      ...
      <AnimatePresence>
        ...
        opacity: 0
      }} className="fixed inset-0 z-50 bg-black/95 flex items-center justify-center" onClick={closeLightbox}>
            <button className="absolute top-4 right-4 text-white hover:text-primary transition-colors" onClick={closeLightbox}>
              <X className="h-8 w-8" />
            </button>
            <button className="absolute left-4 top-1/2 -translate-y-1/2 text-white hover:text-primary transition-colors" onClick={e => {
          e.stopPropagation();
          prevImage();
        }}>
              <ChevronLeft className="h-12 w-12" />
            </button>
            <button className="absolute right-4 top-1/2 -translate-y-1/2 text-white hover:text-primary transition-colors" onClick={e => {
          e.stopPropagation();
          nextImage();
        }}>
          ...
          opacity: 0,
          scale: 0.9
        }} className="max-w-5xl max-h-[80vh] px-4" onClick={e => e.stopPropagation()}>
              <img src={images[lightboxIndex].src} alt={images[lightboxIndex].title} className="max-w-full max-h-[70vh] object-contain mx-auto" />

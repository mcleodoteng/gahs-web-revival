        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-foreground/80 leading-relaxed">
                GAHS seeks to win souls for Christ through a wholistic approach to quality healthcare in families, households and communities — treating all with human dignity, respect and tolerance.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-foreground/80 leading-relaxed">
                To be the leading faith-based healthcare network in Ghana — delivering compassionate care, producing quality health professionals, and transforming communities for a healthier future.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            <blockquote className="text-lg text-foreground/80 leading-relaxed italic mb-4">
              "The medical missionary work is to act as the right hand — used to open doors through which the body may find entrance."
            </blockquote>
